...
class Grader(X64Grader):
    ...
    def grade(answer: str) -> tuple[bool, list[tuple[str, str]]]:
        ...
        uc.reg_write(UC_X86_REG_RAX, 0xbaadc0de)    
        uc.reg_write(UC_X86_REG_RBX, 0xdeadbeef)
        
        Grader.run_unicorn(code, uc)

        solved = uc.reg_read(UC_X86_REG_RAX) == 0xdeadbeef and uc.reg_read(UC_X86_REG_RBX) == 0xbaadc0de
